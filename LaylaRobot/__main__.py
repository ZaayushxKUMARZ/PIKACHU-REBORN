...
from REBORN-PIKACHU.modules import ALL_MODULES
from REBORN-PIKACHU.modules.helper_funcs.chat_status import is_user_admin
from REBORN-PIKACHU.modules.helper_funcs.misc import paginate_modules
...
Maintained by @DARKSHADOW_XD ❤
"""

buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/REBORN_PIKACHUBOT?startgroup=true"),
    ],
    [
    ...
    [
        InlineKeyboardButton(text="ʟᴏɢꜱ", url=f"https://t.me/PIKACHU_SUPPORT"),
        InlineKeyboardButton(
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *Pikachu*
                 \nHere is the [Source Code](https://github.com/ZaayushxKUMARZ/PIKACHU-REBORN) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
